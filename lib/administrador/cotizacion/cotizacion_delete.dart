...
class _CotizacionEditarScreenState extends State<CotizacionEditarScreen> {
    ...
    try {
      await FirebaseFirestore.instance
          ...
          .update({
            ...
            'items': _items,
            // Puedes agregar aquí el recálculo de subtotal/total si editas productos/precios
          });
  ...
  Future<void> _eliminarCotizacionCompleta() async {
    final confirm = await showDialog<bool>(
      context: context,
      builder: (ctx) => AlertDialog(
        title: const Text("¿Eliminar cotización?"),
        content: const Text(
          "Esta acción no se puede deshacer.\n¿Seguro que quieres eliminar la cotización completa?",
        ),
        actions: [
          TextButton(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'Eliminar toda la cotización',
            onPressed: _eliminarCotizacionCompleta,
          ),
        ],
      ),
      body: Padding(
